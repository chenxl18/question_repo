...
class QuestionsCollection(models.Model):
    ...
    def __str__(self):
        if self.status:
            ...
            ret = "取消收藏"
        return "{}:{}:{}".format(self.user,ret,self.question.title)
...
class Answers(models.Model):
    ...
    def __str__(self):
        return "{}-{}".format(self.user,self.question.title)
...
class AnswersCollection(models.Model):
    ...
    def __str__(self):
        ...
        return "{}:{}:{}".format(self.user,ret,self.answer)
...
class UserLog(models.Model):
    ...
    def __str__(self):
        ...
        if self.question:
            ...
            msg = self.answer
        return "{}{}{}".format(self.user, self.operate, msg)
